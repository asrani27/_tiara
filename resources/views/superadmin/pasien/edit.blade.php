...
<div class="row">
    <div class="col-12">
        <a href="/superadmin/pasien" class="btn btn-sm btn-secondary"><i class="fas fa-arrow-left"></i>
            Kembali</a><br /><br />
        <form method="post" action="/superadmin/pasien/{{$data->id}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
