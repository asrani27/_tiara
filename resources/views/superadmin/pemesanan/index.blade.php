...
<div class="row">
    <div class="col-12">
        <a href="/superadmin/pemesanan/create" class="btn btn-sm bg-gradient-purple"><i class="fas fa-plus"></i>
            Tambah</a>
        <br /><br />
        <div class="card">
                ...
                <table class="table table-striped table-valign-middle">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size:12px; font-family:Arial, Helvetica, sans-serif">
                            ...
                            <td>
                                <a href="/superadmin/pemesanan/{{$item->id}}/delete" class="btn btn-xs btn-danger"><i
